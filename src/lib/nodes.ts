...
export const NODE_TYPES: NodeTypeDef[] = [
  // ---- Core ----
  {
    ...
    category: "core",
    label: "Start",
    description: "Where the workflow begins — every run starts here.",
    icon: "play",
    inputs: 0,
    outputs: one,
    fields: [],
  ...
  },
  {
    ...
    category: "core",
    label: "Finish",
    description: "Stop the workflow — nothing runs after this step.",
    icon: "stop",
    inputs: 1,
    outputs: [],
    fields: [],
  ...
  },
  {
    ...
    category: "core",
    label: "Set Variable",
    description: "Save a value to reuse in later steps.",
    icon: "variable",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "core",
    label: "Note",
    description: "Leave a comment for yourself or teammates — skipped when the workflow runs.",
    icon: "note",
    inputs: 1,
    outputs: one,
  ...
  // ---- Navigation ----
  {
    ...
    category: "navigation",
    label: "Open Page",
    description: "Open a web page by its address.",
    icon: "link",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "navigation",
    label: "Click",
    description: "Click a button, link, or any element on the page.",
    icon: "click",
    inputs: 1,
    outputs: one,
  ...
  },
  {
    ...
    category: "navigation",
    label: "Scroll",
    description: "Scroll the page to load more content or reach an element.",
    icon: "scroll",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "navigation",
    label: "Wait",
    description: "Pause for a fixed amount of time before continuing.",
    icon: "clock",
    inputs: 1,
    outputs: one,
  ...
  },
  {
    ...
    category: "navigation",
    label: "Go Back",
    description: "Return to the previous page in browser history.",
    icon: "back",
    inputs: 1,
    outputs: one,
    fields: [],
  ...
  // ---- Interaction ----
  {
    ...
    label: "Fill Field",
    description: "Enter text into a form field instantly.",
    icon: "input",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "interaction",
    label: "Type Text",
    description: "Type text one character at a time, like a real person.",
    icon: "keyboard",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  // ---- Extract ----
  {
    ...
    category: "extract",
    label: "Extract Text",
    description: "Grab an element's visible text and save it to a variable.",
    icon: "scan-text",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    description: "Save an element's attribute — like a link's URL — to a variable.",
    icon: "link",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "extract",
    label: "Screenshot",
    description: "Capture an image of the current page.",
    icon: "camera",
    inputs: 1,
    outputs: one,
    fields: [],
  ...
  // ---- Logic / Flow ----
  {
    ...
    label: "Repeat",
    description:
      "Run the connected steps repeatedly — once per item, through pagination, or a set number of times.",
    icon: "repeat",
    inputs: 1,
    outputs: [
      { id: "loop", label: "each" },
  ...
  },
  {
    ...
    category: "logic",
    label: "Condition",
    description: "Split the workflow into two paths based on a rule.",
    icon: "branch",
    inputs: 1,
    outputs: [
      { id: "true", label: "true" },
  ...
  },
  {
    ...
    category: "logic",
    label: "Delay",
    description: "Pause between steps to pace the workflow.",
    icon: "timer",
    inputs: 1,
    outputs: one,
    fields: [{ name: "ms", label: "Milliseconds", kind: "number", default: "1000", required: true }],
  ...
  // ---- Data / Output ----
  {
    ...
    category: "data",
    label: "Add Row",
    description: "Add a row of data to a collection you can export later.",
    icon: "table",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    category: "data",
    label: "Export CSV",
    description: "Download your collected data as a CSV spreadsheet.",
    icon: "download",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  },
  {
    ...
    description: "Write text and variables to a downloadable text file.",
    icon: "file-text",
    inputs: 1,
    outputs: one,
    fields: [
  ...
  // ---- AI ----
  {
    ...
    category: "ai",
    label: "Generate Text",
    description: "Use AI to write, summarize, or transform text.",
    icon: "sparkles",
    inputs: 1,
    outputs: one,
    fields: [
